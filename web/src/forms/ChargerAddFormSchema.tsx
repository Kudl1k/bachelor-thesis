  ...
  return (
    <Card className="mb-10">
      <CardHeader>
        ...
        <CardDescription>
          Here you can create a new charger, that will be use for charging
          batteries
        </CardDescription>
      </CardHeader>
      <CardContent>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      {...field}
                      placeholder="Enter the baud rate of the charger..."
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      {...field}
                      placeholder="Enter the data bits of the charger..."
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      {...field}
                      placeholder="Enter the stop bits of the charger..."
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      {...field}
                      placeholder="Enter the parity of the charger..."
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      {...field}
                      placeholder="Enter the slots of the charger..."
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
